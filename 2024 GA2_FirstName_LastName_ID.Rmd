...
ANSWER1 = paste0("In this dataset we have ", nrow(ds.txi), " genes")
...
ANSWER4 =  paste("Pearson correlation coefficient: ", round(pearson_corr, 2), "\nSpearman correlation coefficient: ", round(spearman_corr, 2))
...
ANSWER7 = "FDR method increases the values of the p-values, which results in fewer p-values being above the set alpha. Thus, the histogram of the "
